...
export const ELEMENT_IDS = Object.freeze({
  ...
  PATH_PREDICTION_LABEL: 'pathPredictionLabel',
  PATH_PREDICTION_STRENGTH_CONTROL: 'pathPredictionStrengthControl',
  PATH_PREDICTION_STRENGTH_DEC_BTN: 'pathPredictionStrengthDecBtn',
  PATH_PREDICTION_STRENGTH_VALUE: 'pathPredictionStrengthValue',
  PATH_PREDICTION_STRENGTH_INC_BTN: 'pathPredictionStrengthIncBtn',

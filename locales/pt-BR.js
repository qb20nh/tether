export default {
  "ui": {
    ...
    "levelGroupCampaign": "Campanha",
    "levelGroupTutorial": "Tutorial",
    "levelGroupPractice": "Prática",
    "levelGroupModes": "Modos",
    "scoreInfiniteLabel": "Pontuação (Infinito)",
    "scoreDailyLabel": "Pontuação (Diário)",
    ...
    "pathPrediction": "Predição de caminho",
    "pathPredictionEnable": "Ativar predição",
    "pathPredictionStrengthNone": "Nenhuma",
    "pathPredictionStrengthLow": "Baixa",
    "pathPredictionStrengthModerate": "Média",
    ...
    "notificationHistoryEmpty": "Ainda não há notificações.",
    ...
    "updateApplyDialogTitle": "Atualização disponível",
    ...
    "updateApplyingOverlay": "Atualizando para a versão mais recente...",

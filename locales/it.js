export default {
  "ui": {
    ...
    "levelGroupCampaign": "Campagna",
    "levelGroupTutorial": "Tutorial",
    "levelGroupPractice": "Pratica",
    "levelGroupModes": "Modalità",
    "scoreInfiniteLabel": "Punteggio (Infinito)",
    "scoreDailyLabel": "Punteggio (Giornaliero)",
    ...
    "pathPrediction": "Predizione del percorso",
    "pathPredictionEnable": "Attiva previsione",
    "pathPredictionStrengthNone": "Nessuna",
    "pathPredictionStrengthLow": "Bassa",
    "pathPredictionStrengthModerate": "Media",
    "pathPredictionStrengthHigh": "Alta",
    "notificationsBlockedToast": "Le notifiche sono bloccate. Consenti l'autorizzazione alle notifiche nelle impostazioni del sito del browser.",
    ...
    "updateApplyDialogTitle": "Aggiornamento disponibile",
    "updateApplyDialogPrompt": "Installare ora l'ultima versione?",
    "updateApplyDialogConfirm": "Aggiorna ora",
    "updateApplyFailedToast": "Impossibile applicare l'aggiornamento ora. Riprova tra poco.",
    "updateApplyingOverlay": "Aggiornamento alla versione più recente in corso...",
    "moveDailyDialogTitle": "Vai al livello giornaliero",
    "moveDailyDialogPrompt": "Hai un livello non completato. Vuoi comunque passare al livello giornaliero?",
    "moveDailyDialogConfirm": "Vai al giornaliero",

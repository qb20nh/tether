...
const LEVEL_STRAIGHT: LevelDefinition = {
  name: 'Straight',
  grid: [
    '...',
    '.s.',
...
const LEVEL_CYCLE: LevelDefinition = {
  name: 'Cycle',
  grid: [
    '..',
    '..',
...
const LEVEL_CORNER: LevelDefinition = {
  name: 'Corner',
  grid: [
    '...',
    '...',
...
const buildSnapshotForPath = (level: LevelDefinition, path: Array<[number, number]>) => {

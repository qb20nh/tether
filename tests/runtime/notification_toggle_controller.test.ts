...
import { createNotificationToggleController } from '../../src/app/notification_toggle_controller.ts';
...
import type { RuntimeData } from '../../src/contracts/ports.ts';
...
const createHarness = (overrides: any = {}) => {
  ...
  const controller = createNotificationToggleController({
    ...
    notificationPermissionState: overrides.notificationPermissionState || (() => 'granted' as NotificationPermissionState),
    supportsNotifications: overrides.supportsNotifications || (() => true),
    canUseServiceWorker: overrides.canUseServiceWorker || (() => true),
    requestNotificationPermission: overrides.requestNotificationPermission || (async () => 'granted' as NotificationPermissionState),

...
const createHistoryEntry = (
  entry: Partial<NotificationHistoryEntry> & Pick<NotificationHistoryEntry, 'source' | 'marker'>,
...
test('historyEntryDotColor applies source rules for all marker states', () => {
  ...
  assert.equal(historyEntryDotColor(({ source: 'unknown', marker: 'older' } as any)), HISTORY_DOT_COLORS.NONE);
});
